...
if (answerKeyForm) {
    answerKeyForm.addEventListener("submit", async e => {
        ...
        try {
            const res = await fetch(`${window.API_BASE}/api/upload-key`, { method: "POST", body: formData });
...
if (answerSheetForm) {
    ...
    answerSheetForm.addEventListener("submit", async e => {
        ...
        const res = await fetch(`${window.API_BASE}/api/upload-answer`, { method: "POST", body: formData });
        const data = await res.json();
...
async function loadAvailableExams() {
    ...
    try {
        const res = await fetch(`${window.API_BASE}/api/get-exams`);
        const data = await res.json();
...
async function loadStudentResults() {
    ...
    try {
        const res = await fetch(`${window.API_BASE}/api/get-student-submissions?student=${encodeURIComponent(studentEmail)}`);
        const data = await res.json();
...
async function loadTeacherStats() {
    ...
    try {
        const res = await fetch(`${window.API_BASE}/api/dashboard-stats`);
        const data = await res.json();
...
async function loadStudentSubmissions() {
    ...
    try {
        const res = await fetch(`${window.API_BASE}/api/student-submissions`);
        const data = await res.json();
...
async function loadPendingSubmissions() {
    ...
    try {
        const res = await fetch(`${window.API_BASE}/api/pending-answers`);
...
document.getElementById("startEvaluationBtn")?.addEventListener("click", async e => {
    ...
    try {
        ...
        const res = await fetch(`${window.API_BASE}/api/ai-evaluate/${encodeURIComponent(roll)}`, { method: "POST" });
        const data = await res.json();
